const saftFile = require(`./files/${(process.argv[2] || 'saft-demo2')}`);
const saft = saftFile.jsonObj;

const { FinancialObject, FinancialStockObject, FinancialOverviewObject } = require('../../models/financial.model');
